...
1. [Week 11 - Time, text, collisions](#week-11---time-text-collisions)
   ...
   2. [Resources](#resources)
      1. [Code](#code)
      2. [Invite me on Github:](#invite-me-on-github)
      3. [More help](#more-help)
   3. [Fixed demo: aiming.](#fixed-demo-aiming)
      1. [Class diagrams of that demo](#class-diagrams-of-that-demo)
   4. [Missiles and Targets](#missiles-and-targets)
      1. [Moving at a given speed](#moving-at-a-given-speed)
   5. [Missiles come in waves in each level](#missiles-come-in-waves-in-each-level)
      1. [Psuedocoding the waves](#psuedocoding-the-waves)
   6. [Doing things over time](#doing-things-over-time)
      1. [Things that need timing](#things-that-need-timing)
      2. [Ways to time](#ways-to-time)
      3. [Invoke](#invoke)
      4. [Update and time.deltaTime.](#update-and-timedeltatime)
      5. [Coroutines](#coroutines)
      6. [Sliding Squares](#sliding-squares)
         1. [More Waves with a coroutine](#more-waves-with-a-coroutine)
         2. [Side notes on coroutines and threads for the curious](#side-notes-on-coroutines-and-threads-for-the-curious)
   7. [Missile explosions](#missile-explosions)
      1. [Hitting things](#hitting-things)
   8. [Scoring/Displaying text](#scoringdisplaying-text)
      1. [Adding UI canvas and text](#adding-ui-canvas-and-text)
      2. [Editing TMP text in script](#editing-tmp-text-in-script)
...
### Invite me on Github:
  - Inviting a collaborator [Github Help](https://help.github.com/en/articles/inviting-collaborators-to-a-personal-repository)
  - How permissions work on personal accounts [Github Help](https://help.github.com/en/articles/permission-levels-for-a-user-account-repository)
  - My username is **dmcgits**
  
![Dmcgits](assets/week11/dmcgits_github.png)
